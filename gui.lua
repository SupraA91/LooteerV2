...
gui.elements = {
   ...
   affix_settings = {
      ...
      --wepeons
         ...
         unique_2h_mace_slider = slider_int:new(0, 4, 0, get_hash(plugin_label .. "_unique_2h_mace_slider")),
         unique_2h_sword_slider = slider_int:new(0, 4, 0, get_hash(plugin_label .. "_unique_2h_sword_slider")),
         unique_2h_axe_slider = slider_int:new(0, 4, 0, get_hash(plugin_label .. "_unique_2h_axe_slider")),
         unique_2h_polearm_slider = slider_int:new(0, 4, 0, get_hash(plugin_label .. "_unique_2h_polearm_slider")),
         unique_staff_slider = slider_int:new(0, 4, 0, get_hash(plugin_label .. "_unique_staff_slider")),
         unique_bow_slider = slider_int:new(0, 4, 0, get_hash(plugin_label .. "_unique_bow_slider")),
         unique_crossbow_slider = slider_int:new(0, 4, 0, get_hash(plugin_label .. "_unique_crossbow_slider")),
